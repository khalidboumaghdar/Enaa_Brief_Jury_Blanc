...
<html lang="en">
    <head>
        <title>ConstructionXpert-S'inscrire</title>
        <!-- Required meta tags -->
        <meta charset="utf-8" />
        <meta
            name="viewport"
                            ...
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                              ...
                              <form class="mx-1 mx-md-4">
                                ...
                                <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                  <button   data-mdb-button-init data-mdb-ripple-init class="btn btn-dark btn-lg btn-block" type="button">S'inscrire</button>
                                </div>
...
<img src="assets/images/logistics1.png" alt="">              
                            </div>
                          </div>
                        </div>
                      </div>
